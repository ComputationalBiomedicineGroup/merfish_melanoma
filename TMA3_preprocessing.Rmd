...
start = Sys.time()
data <- LoadVizgen(data.dir = "~/merfish/TME_3/", 
                   fov="full", 
                   assay = "Vizgen", 
                   verbose = T, 
...
data = FindClusters(data, resolution = 0.1) # , resolution = 0.06
```
...
```{r save data}
saveRDS(data, file = "~/export/merfish2/merfishTMA3_all_except_wrong_tissue.rds")
```
