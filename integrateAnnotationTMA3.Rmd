...
```{r}
data = readRDS("~/export/merfish2/merfishTMA3_area_filtered.rds")
```
...
```{r}
fb_list = read.table("~/export/merfish2/fibroblast_with_endothelial_TMA3.txt", colClasses = "character")$V1
...
annotation_metadata_filtered <- annotation_metadata[annotation_metadata$orig.ident == "TMA3", ]
...
```{r}
# Store Object
saveRDS(data, file="~/export/merfish2/merfishTMA3_annotated.rds")
```
